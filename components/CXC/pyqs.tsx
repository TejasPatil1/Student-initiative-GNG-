    ...
    <section className="space-y-6">
      <header className="text-center mb-8">
        ...
        <p className="text-sm sm:text-base text-muted-foreground">
          Access and explore previous year exam questions by subject, year, and type
        </p>
      </header>
